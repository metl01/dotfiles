...
static const char foreground2[]       = "#2e383c";
static const char accent[]          = "#83c092";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { foreground, background, col_gray1 },
	[SchemeSel]  = { foreground2, accent, accent  },
};
...
static const char *dmenucmd[] = { "dmenu_desktop", "-m", dmenumon, "-fn", dmenufont, "-nb", background, "-nf", foreground, "-sb", accent, "-sf", foreground2, NULL };
...
static const Key keys[] = {
  ...
  { 0,                            XK_Print,  spawn,          {.v = screenshotcmd } },
	...
	{ MODKEY|ShiftMask,             XK_Return, swaptomaster,           {0} },
