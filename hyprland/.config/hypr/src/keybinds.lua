...
hl.bind("PRINT", hl.dsp.exec_cmd("grimblast --notify --freeze copysave area $HOME/Pictures/Screenshots/$(date +'%Y-%m-%d_%H-%M-%S').png"))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("dms ipc call powermenu toggle"))
